              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(_pages[index]['title'],
                    style: mystyle.get_plus_jakarta_black_bold(FontWeight.w700,
                        height*0.028),
                ...
                Container(
                  ...
                  child: Text(_pages[index]['description'],
                    style: mystyle.get_plus_jakarta_black(FontWeight.w400, height*0.018),
                    textAlign: TextAlign.center,
                  ),
                ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("${currentPage+1}/2",
                        style: mystyle.get_plus_jakarta_black(FontWeight.w600, height*0.018),
                        textAlign: TextAlign.center,
                      ),
                      InkWell(
                        onTap: (){
  ...
  _pageController.jumpToPage(1);
                        ...
                        child: Row(
                          children: [
                            ...
                            Image.asset("images/Double Right.png",height: height*0.025  ,)
                          ],
                        ),
                      ),
                    ],
