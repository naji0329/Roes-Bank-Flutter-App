...
import 'package:rosebank/Screens/bill%20payment%20Detail.dart';
...
padding: EdgeInsets.all(8),
              ...
              ListTile(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context){
                    return BillPaymentDetailScreen();
                  }));
                },
        ...
        Center(child: Image.asset("images/indicator.png",height: height*0.02,))
